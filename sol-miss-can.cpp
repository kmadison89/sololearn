...
/**
 * My solution to the Missionaries and Cannibals Problem
 * @@Author: Ace
 * Bugs: None known
 * Version:
 * 0.0.0.1 - display written and tested
 * 0.0.0.2 - added win and begin solution()
 * 0.0.0.3 - logic error fixes in solution, alogorithm finalized
 * 0.0.0.4 - solution() completed. added main() driver
 * 0.0.0.5 - Code cleanup, detailed more comments
 * 0.0.0.6 - Released
